...
///
/// UPDATE:
/// This function was inativated, because its state size was huge (about 163 bytes long), alternatives
/// are being developed. Meanwhile we are by passing direct to the LCD instead of passing information
